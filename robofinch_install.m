...
dependency(2).chk='zftftb_pretty_sonogram';
dependency(2).url='https://github.com/jmarkow/zftftb.git';
dependency(2).basedir='';

dependency(3).name='robofinch';
dependency(3).chk='';
dependency(3).url='';
